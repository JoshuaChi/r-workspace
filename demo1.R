...
setSymbolLookup(A.Share.index=list(name="000002.sz",src="google"))
stock<-"A.Share.index"
download(stock, from="2014-09-01")
A.Share.index<-read(stock)
chartSeries(A.Share.index, TA = "addVo(); addSMA(); addEnvelope();addMACD(); addROC()")
